...
export type Query = {
  ...
  splitMetadata?: Maybe<SplitMetadata>;
  splitMetadata_collection: Array<SplitMetadata>;
  splits: Array<Split>;
  token?: Maybe<Token>;
...
export type QuerySplitMetadata_CollectionArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type SubscriptionSplitMetadata_CollectionArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<SplitMetadata_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
...
export type PoolDetailsByIdQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;
