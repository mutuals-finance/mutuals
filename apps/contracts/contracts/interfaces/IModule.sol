...
interface IModule is IERC165 {
   ...
   * @dev Called by the Pool during `installModule`.
   ...
   * @dev Called by the Pool during uninstall (if implemented).
   ...
   * The vendor and module names MUST NOT contain a period character.
