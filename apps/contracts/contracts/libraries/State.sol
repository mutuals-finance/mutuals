...
library State {
    ...
    function update(Data storage self, Allocation.Data calldata allocation, address token, uint256 amount) internal {
    ...
    function getWithdrawDelta(
        ...
        return
            self.getWithdrawLimit(allocation, received, aggregatePeriods) -
            self.getWithdrawn(allocation, token, aggregatePeriods);
    }
    ...
    function periodOf(Data storage self, Allocation.Data calldata allocation) internal view returns (uint256) {
