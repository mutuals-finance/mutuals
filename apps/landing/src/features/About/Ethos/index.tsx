    ...
    <Box bg={"bg.subtle"}>
      <Container py={{ base: "16", lg: "32" }} maxW="3xl">
        ...
        <Stack gap={"2"}>
          ...
          <Text>
            Onchain adoption sees continous growth, and Mutuals has evolved
            beyond basic payment splitting into a complete revenue management
            platform handling percentage-based allocations, recurring payments,
            timelock distributions, and real-time earnings tracking across
          ...
          <Text>
            ...
            finance, it gives teams superpowers. It works transparently
            alongside them and creates more efficient, trustworthy financial
            operations. If you&#39;re excited about building this future, come
            join us.
          </Text>
        </Stack>
      </Container>
