      ...
      <Container maxW="container.xl" px={{ base: "6", lg: "12" }}>
        ...
        <Accordion allowMultiple as={Stack} width="100%" spacing="3">
          <FAQItem title="Why is it for free?" roundedTop="3xl">
            <Text>
              Withdrawing funds from Splits will transfer your balance(s) from
              the Splits ecosystem into your wallet. To withdraw funds, follow
              these steps:
            </Text>
            <OrderedList spacing={1} p={3}>
              <ListItem>
                Click the &apos;Connect Wallet&apos; button to connect your
                wallet to the app. If you&apos;re new to Ethereum and don&apos;t
                yet have a wallet, you can learn more here.
              </ListItem>
              <ListItem>
                In the top left of the screen, you’ll see your account. If you
                have funds to withdraw, you will see a balance listed next to
                your account.
              </ListItem>
              <ListItem>
              ...
              <ListItem>
                Click the checkboxes next to each balance you want to withdraw.
                You can select as many balances as you’d like.
              </ListItem>
              <ListItem>
            ...
            <Text>
              ...
              maximize efficiency and reduce costs, since if you receive a very
              small portion of a Split and had to withdraw for that specific
              Split, there’s a good chance it would cost more to withdraw than
