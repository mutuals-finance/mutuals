...
<ol>
  <li>If integrity of the claim can be asserted, meaning that the content of the claim corresponds to the intended allocation. This is determined by utilizing an on-chain reference (e.g., a hash or a mapping), which was previously stored by a trustee during the pool's setup phase.</li>
  <li>If the recipient of the withdrawal matches the claim's designated recipient</li>
</ol>
