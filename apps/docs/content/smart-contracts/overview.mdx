---
title: Overview
description: Introduction to the Mutuals protocol architecture, components, and claim execution flow.
---

The Mutuals protocol is a modular payment distribution system built on Ethereum and compatible EVM chains. The protocol separates validation logic from distribution logic through a plugin architecture, allowing different authorization mechanisms and distribution strategies to be combined flexibly.
